    ...
    try:
        ...
        cur.execute("""
            UPDATE stocks SET
                ...
                volume = %s, trade_date = %s, updated_at = NOW()
            WHERE symbol = %s
        """, (open_p, high, low, close, change, change_pct, volume, trade_date, symbol))
        updated += 1
...
for item in r2.json():
    ...
    try:
        ...
        cur.execute("""
            ...
            WHERE symbol = %s
        """, (open_p, high, low, close, change, change_pct, volume, symbol))
        updated2 += 1
    except Exception as e:
